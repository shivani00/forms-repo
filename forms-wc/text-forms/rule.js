    ...
    "ruleVersions": [{
        ...
        "rule": function () {
            ...
            function executeCondition() {
                ...
                // Code Logic
                if (isRuleFired) {
                    createNewFormsListItemXX(data, "FRM 35480", "<form edition date usually XX XX for WC>", "MI/RI Controller Insurance", "<action default its add>", <displayInd>, <manuscriptInd>, <printInd>, <pulllistInd>, "<formtype>", <applicableStateCd usually null>, <handlingTypecd usually null>, <occurrenceId usually null>,"<display Form nUmber>", "MI/RI Cntrl Ins", <localprintEligibleInd>, <documentCategoryCd usually null>, <documentTitleTxt usually null>, <processBehaviourCd usually null>)
                }
            }
        },
        "notes":
